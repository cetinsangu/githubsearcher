...
function UserBio() {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="mt-20 relative p-3 dark:border dark:border-white rounded-tl-none rounded-xl bg-white dark:bg-gray-900  font-roboto before:content-['User'] before:absolute before:top-0 before:left-0 before:-translate-y-full before:text-black dark:before:text-white before:bg-white dark:before:bg-gray-900 before:px-5 before:py-1 before:border before:rounded-t-lg before:font-light"
    >
      <motion.div
        variants={headItem}
