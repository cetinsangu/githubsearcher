  ...
  return (
    <div>
      <motion.div
        ...
        viewport={{ once: true }}
        initial="hidden"
        className="mt-20 md:mt-10 relative rounded-tl-none border border-white dark:bg-gray-900 rounded-xl flex flex-col bg-white font-roboto before:content-['Followings'] before:absolute before:top-0 before:left-0 before:-translate-y-full before:text-black dark:before:text-white before:bg-white dark:before:bg-gray-900  before:px-5 before:py-1 before:border before:rounded-t-lg before:font-light h-80"
      >
